...
/**
 * Class for filtering input from world to account for height
 * differences between the detected position and the real position
 * at ground level.
 * 
 * @author s0952880
 */
public class HeightFilter {
	 ...
	 * 
	 * @param worldCenter Point directly below the camera.
	 * @param cameraHeight The height of the camera above worldCenter.
	 */
